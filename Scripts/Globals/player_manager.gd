#https://github.com/matjlars/godot-multiplayer-input/blob/main/addons/multiplayer_input/demo/player_manager.gd
extends Node
...
signal sig_player_joined(player_index : int)
signal sig_player_left(player_index : int)
